...
const content = {
  ...
  fields: [
    ...
    },
    {
      ...
      component: 'select',
      options: [
        {label: 'Narrow', value: 'max-w-66'},
        {label: 'Medium', value: 'max-w-90'},
        {label: 'Wide', value: 'max-w-114'},
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                options: [
                  {label: '200px', value: 'md:h-50'},
                  {label: '300px', value: 'md:h-75'},
                  {label: '400px', value: 'md:h-100'},
                  {label: '500px', value: 'md:h-125'},
                  {label: '600px', value: 'md:h-150'},
                  {label: '700px', value: 'md:h-175'},
                  {label: '800px', value: 'md:h-200'},
                ],
              },
              {
                label: 'Aspect Ratio',
                ...
                options: [
                  ...
                  {label: '16:9', value: 'md:aspect-video'},
              ...
              },
              {
                ...
                options: [
                  {label: 'None', value: ''},
                  {label: '200px', value: 'md:min-h-50'},
                  {label: '300px', value: 'md:min-h-75'},
                  {label: '400px', value: 'md:min-h-100'},
                  {label: '500px', value: 'md:min-h-125'},
                  {label: '600px', value: 'md:min-h-150'},
                  {label: '700px', value: 'md:min-h-175'},
                  {label: '800px', value: 'md:min-h-200'},
                ],
              },
              {
                ...
                options: [
                  {label: 'None', value: ''},
                  {label: '200px', value: 'md:max-h-50'},
                  {label: '300px', value: 'md:max-h-75'},
                  {label: '400px', value: 'md:max-h-100'},
                  {label: '500px', value: 'md:max-h-125'},
                  {label: '600px', value: 'md:max-h-150'},
                  {label: '700px', value: 'md:max-h-175'},
                  {label: '800px', value: 'md:max-h-200'},
                ],
              },
            ],
            defaultValue: {
              heightType: 'static',
              staticHeight: 'md:h-175',
              aspectRatio: 'md:aspect-video',
              minHeight: '',
              maxHeight: '',
            },
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                description: 'If enabled, hero set to static height',
                options: [
                  {label: '200px', value: 'max-md:h-50'},
                  {label: '300px', value: 'max-md:h-75'},
                  {label: '400px', value: 'max-md:h-100'},
                  {label: '500px', value: 'max-md:h-125'},
                  {label: '600px', value: 'max-md:h-150'},
                  {label: '700px', value: 'max-md:h-175'},
                  {label: '800px', value: 'max-md:h-200'},
                ],
              },
              {
                label: 'Aspect Ratio',
                ...
                options: [
                  ...
                  {label: '16:9', value: 'max-md:aspect-video'},
              ...
              },
              {
                ...
                options: [
                  {label: 'None', value: ''},
                  {label: '200px', value: 'max-md:min-h-50'},
                  {label: '300px', value: 'max-md:min-h-75'},
                  {label: '400px', value: 'max-md:min-h-100'},
                  {label: '500px', value: 'max-md:min-h-125'},
                  {label: '600px', value: 'max-md:min-h-150'},
                  {label: '700px', value: 'max-md:min-h-175'},
                  {label: '800px', value: 'max-md:min-h-200'},
                ],
              },
              {
                label: 'Aspect Ratio Max Height',
                ...
                options: [
                  {label: 'None', value: ''},
                  {label: '200px', value: 'max-md:max-h-50'},
                  {label: '300px', value: 'max-md:max-h-75'},
                  {label: '400px', value: 'max-md:max-h-100'},
                  {label: '500px', value: 'max-md:max-h-125'},
                  {label: '600px', value: 'max-md:max-h-150'},
                  {label: '700px', value: 'max-md:max-h-175'},
                  {label: '800px', value: 'max-md:max-h-200'},
                ],
              },
            ],
            defaultValue: {
              heightType: 'static',
              staticHeight: 'max-md:h-125',
